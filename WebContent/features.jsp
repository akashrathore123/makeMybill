		...
		<div class="container">
			<div class="row">
				<div class="col-sm-4 text-center feature">
					...
					<h3>Get Instant Bill</h3>
					<p>
					   Now you can generate your electricity bill at any time any place.
					</p>
				</div>
				<div class="col-sm-4 text-center feature">
					...
					<p>
					  Ease with operating application and you can contact us any time.
					</p>
				</div>
				<div class="col-sm-4 text-center feature">
					<i class="fa fa-star icon"></i>
					<h3>Complain will be heard</h3>
					<p>
					   Complain from your home and check status any time.Problem will be solved as soon as possible.
					</p>
				</div>
			</div>
		</div>
