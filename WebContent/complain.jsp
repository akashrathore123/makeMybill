<!DOCTYPE html>
	<html lang="en">
		...
		<body >
    	  ...
    	  <div class="modal-dialog" ng-app="home">
...
<h2 style="margin-left: 38%">Register Your Complain:</h2></span>
    ...
    <form class="form-signin">       
      ...
      <input type="text" class="form-control" name="meterID" placeholder="Meter ID" required="" autofocus="" />
      <input type="text" class="form-control" name="complain" placeholder="Problem" required=""/>      
       <input type="text" class="form-control" name="phone" placeholder="Contact No." required="" autofocus="" />
