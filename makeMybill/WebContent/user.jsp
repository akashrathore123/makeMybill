<!DOCTYPE html>
	<html lang="en">
		...
		<body ng-app="user" ng-controller="data">
...
<ul class="list-group">
  <li class="list-group-item"><h3>Meter Id:   &nbsp &nbsp {{bill.meterId}}</h3></li>
  <li class="list-group-item"><h3>User Id:  &nbsp &nbsp {{bill.userId}}</h3></li>
  <li class="list-group-item"><h3>Current Meter Reading: &nbsp &nbsp {{bill.totalUnit}} Unit</h3></li>
  <li class="list-group-item"><h3>Last Paid Month: &nbsp &nbsp {{bill.lastMonthPaid}} </h3></li>
  <li class="list-group-item"><h3>Amount Paid:&nbsp &nbsp Rs.{{bill.lastPaidAmount}}</h3></li>
  <li class="list-group-item"><h3>Unbilled Amount: &nbsp &nbsp Rs.{{bill.unbilledAmount}}</h3></li>
  <li class="list-group-item"><h3>Total Paid Amount:&nbsp &nbsp Rs.{{bill.totalPaid}}</h3></li>	
</ul>
				
			</div>
			</div>
        
 		<button class="button" ng-click="sendMail()">Generate Bill</button>
