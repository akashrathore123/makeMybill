<!DOCTYPE html>
	<html lang="en">
		<head>
			...
			<title>makeMybill || Register Complain</title>
...
<br><br><br><br>
<div>
<h2 style="margin-left: 38%">Register Your Complain:</h2></span>
         <div class="wrapper" ng-controller="addComplain">
    <form class="form-signin">       
      
      <input type="text" class="form-control" name="meterID" ng-model="user1.meterID" placeholder="Meter ID"  required="" autofocus="" />
      <input type="text" class="form-control" name="complain" ng-model="user1.problem" placeholder="Problem" required=""/>      
       <input type="text" class="form-control" name="phone" ng-model="user1.contact" placeholder="Contact No." required="" maxlength="10" autofocus="" />
      <input type="text" class="form-control" name="address" ng-model="user1.address" placeholder="Address" required=""/> 
      <button class="btn btn-lg btn-primary btn-block"  ng-click="registerComplain()">Register</button>   
      <span id="complainError" style="color: red" >{{complainError}}</span>
       <span id="complainStatus" >{{complainStatus}}</span>
    </form>
  </div>
    </div>
